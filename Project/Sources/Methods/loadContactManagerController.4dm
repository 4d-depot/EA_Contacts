...
Case of 
	: ($contactAction_t="On Saving Contact")
		...
		If (lastUpdatedContact_e.category#Null:C1517)
			lastSelectedCategoryPos_l:=Form:C1466.categories.data.findIndex(Formula:C1597($1.result:=$1.value.Name=$2); lastUpdatedContact_e.category.Name)+1
...
Case of 
	: ($contactAction_t="On Deleting Contact")
		...
		Else 
			$categoryRow_l:=Form:C1466.categories.data.findIndex(Formula:C1597($1.result:=$1.value.Name=$2); lastUpdatedContact_e.category.Name)
